...
test("cvwd-us parser normalizes the synthetic CVWD water statement", async () => {
  ...
  const bill = parseBill({ content, contentType: "text", sourceUrl: "https://www.cvwdwater.com/mybill" });
